...
@auth.route('/user', methods=['GET', 'DELETE', 'POST'])
@login_required
def manage_user():
    ...
    if request.method == 'GET':
        return render_template('user_page.html', user=user, current_user=current_user)
        ...
        flash('User and associated data deleted successfully!', category='success')
